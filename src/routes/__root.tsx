...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Boostivo — SMM Panel TON" },
      { name: "description", content: "Boostivo : achetez followers, likes et vues sur Instagram, TikTok, Telegram et plus. Paiement TON, livraison automatique." },
      { property: "og:title", content: "Boostivo — SMM Panel TON" },
