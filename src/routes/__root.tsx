...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Boostvari : achetez followers, likes et vues sur Instagram, TikTok, Telegram et plus. Paiement TON, livraison automatique." },
      ...
      { property: "og:site_name", content: "Boostvari" },
